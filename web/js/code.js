...
function previewInit() {
    ...
    leftButton.addEventListener('click', () => {
        if (left.style.display == 'none') {
            ...
            setTimeout(() => {
                middle.style.transform = 'translateX(139px) translateY(-50%)';
    ...
    rightButton.addEventListener('click', () => {
        if (right.style.display == 'none') {
            ...
            setTimeout(() => {
                middle.style.transform = 'translateX(-516px) translateY(-50%)';
                middle.style.clipPath = "polygon(80% 0, 100% 0, 100% 100%, 80% 100%)";
            }, 300);
        }
